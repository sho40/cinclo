  ...
  return (
    <Layout>
      <div className={styles.container}>
        ...
        <section>
          <h2>
            シンクロは弊社おすすめのセレクトブランドを1週間レンタルできるサービスになっております
            <br />
            また、レンタル回数に応じて割引率が変動！
          </h2>
        </section>
        ...
        <section>
          ...
          <p>
            使用用途に合うようにお好きな服を選んで
            <br />
            <span>※特にサイズ要チェック</span>
            <br />
            レンタル1回目のアイテムは定価から80%OFFとなっております
            <br />
            例:￥10000→￥2000
            <br />
            レンタル毎に前価格の5%OFFとなります
            <br />
            例:￥2000→￥1900
          </p>
        </section>
        ...
        <section>
          <h3>④送られてきた箱に返送</h3>
          <p>
            お送りした際の箱をそのまま返送にご使用下さい。
            <br />
            箱の紛失・破損の場合はお客様自身でご用意の上返送をお願い致します。
            <br />
            返送用の伝票は同梱させて頂いております。
          </p>
        </section>
        ...
        <section>
          <h3>⑥破損について</h3>
          <p>
            基本的にはレンタルアイテムの為、経年劣化を加味したサービスとなっております。
            <br />
            ただし返送品を確認した際、著しい破損の場合修繕費(委託先に出していただくお見積額)をご請求致します。
            <br />
            破損パターン例
            <br />
            シミ・破れ・ファスナー・装飾・焦げ等
        ...
        <section>
          <div ref={aboutPurchaseElement}>
            <h3>secret</h3>
            <p>
              レンタル回数14回を終えたアイテムはお買い上げ可能となり
              <br />
              その際の価格は最終価格の50%OFFとなります。
              <br />
              例:レンタル14回目の価格が1000円の場合、500円でお買い上げ可能です。
              <br />
              →定価の約95%OFF!!
            </p>
          </div>
